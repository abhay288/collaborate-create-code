...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      mentor_chat_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "mentor_chat_messages_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      mentor_chat_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentor_chat_sessions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      skill_gap_analyses: {
        ...
        Relationships: [
          {
            foreignKeyName: "skill_gap_analyses_career_id_fkey"
            columns: ["career_id"]
            isOneToOne: false
            referencedRelation: "careers"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_distinct_college_districts: {
        Args: { p_state: string }
        Returns: {
          district: string
        }[]
      }
      get_distinct_college_states: {
        Args: never
        Returns: {
          state: string
        }[]
