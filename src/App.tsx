...
const ProfileStrengthPage = lazy(() => import("./pages/ProfileStrengthPage"));
const CareerRiskPage = lazy(() => import("./pages/CareerRiskPage"));
...
const VoiceConfidencePage = lazy(() => import("./pages/VoiceConfidencePage"));
        ...
        <BrowserRouter>
          <AuthProvider>
            <Suspense fallback={<PageLoader />}>
              ...
              <Route path="/voice-confidence" element={<ProtectedRoute><VoiceConfidencePage /></ProtectedRoute>} />
              <Route path="/typing-test" element={<ProtectedRoute><TypingTestPage /></ProtectedRoute>} />
              ...
              <Route path="/profile-strength" element={<ProtectedRoute><ProfileStrengthPage /></ProtectedRoute>} />
              <Route path="/career-risk" element={<ProtectedRoute><CareerRiskPage /></ProtectedRoute>} />
              <Route path="/career-compare" element={<ProtectedRoute><CareerComparePage /></ProtectedRoute>} />
